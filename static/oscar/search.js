...
var search = (function () {
		...
		function _call_ts(rule_category, rules, rule_index, sparql_query, query_text=null, query_label=null, callbk_fun=null, attempt = 0) {
			// Progressive timeout: 30s, 60s, 5min
			const timeouts = [30000, 60000, 300000];
                ...
                <div class="col-12">
                    <div class="search-entry text-center">
                        ...
                        <form class="input-group search-box" action="${search_base_path}" method="get">
                            <input type="text" class="form-control theme-color" placeholder="Search DOI, PMID, ARXIV ... e.g., 10.1016/J.WEBSEM.2012.08.001" name="text">
